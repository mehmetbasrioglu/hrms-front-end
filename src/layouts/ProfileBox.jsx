...
function ProfileBox({children,button,buttonState=false,secondary,onClick,marginBottom,headerText,padding,width,height,margined,zoomed,className,unanimated}) {
    return (
        <div >
            <div 
